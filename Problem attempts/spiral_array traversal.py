...
class Solution:
    ...
    def spiralOrder(self, matrix: List[List[int]]) -> List[int]:
        ...
        while available_rows > 0:
            ...
            col = self.move_right(row, col, col_limit, visited, matrix)
            row += 1
            row = self.move_down(row, col, row_limit, visited, matrix)

            available_rows -= 1
            row_lim_rev += 1

            col -= 1
            col = self.move_left(row, col, col_lim_rev, visited, matrix)
            row -= 1
            row = self.move_up(row, col, row_lim_rev, visited, matrix)
            col += 1
    ...
    def move_right(self, row, col, col_limit, visited, matrix):
        while col < col_limit:
    ...
    def move_down(self, row, col, row_limit, visited, matrix):
        while row < row_limit:
            visited.append(matrix[row][col])
            row += 1
    ...
    def move_left(self, row, col, col_lim_rev, visited, matrix):
    ...
    def move_up(self, row, col, row_lim_rev, visited, matrix):
